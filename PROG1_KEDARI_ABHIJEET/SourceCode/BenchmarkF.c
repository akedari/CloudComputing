...
void* threadOperation(void *arg)
{
	...
	while(1)
		{
		int addition = 4.4+2.4 + 4.6+2.4 + 4.4+2.4 + 4.4+2.4 + 4.7+2.2 + 4.6+2.2+ 4.2+2.2 +	4.5+2.5 + 4.7+2.3 +	4.9+2.5 + 5.4+2.4 +	7.4+2.3 + 8.4+2.2 + 3.4+2.1 +5.5+2.2 + 6.1+2.3 + 9.4+2.3 + 4.4+2.3 + 4.4+2.8 + 4.3+2.6 + 3.4+2.4;
